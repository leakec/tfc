...
from tfc.utils import egrad, NLLS, LS
...
a = 1   # specific problem type, a >=0 (analytical solution known for a = 0, 1, and 5)
xspan = np.array([0., 10.]) # problem domain range [x0, xf], where x0 > 0
