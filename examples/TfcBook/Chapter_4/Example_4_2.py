...
print("x: {0}".format(X['x'][0]))
print("y: {0}".format(X['y'][0]))
print("z: {0}".format(X['z'][0]))
print("Error in x: {0}".format(np.abs(X['x']+3.)[0]))
print("Error in y: {0}".format(np.abs(X['y']-4.)[0]))
print("Error in z: {0}".format(np.abs(X['z']-4.)[0]))
